...
def run() -> None:
	...
	if matches_created < 2:
		raise ValueError(f'expected at least two TenderMatch rows before preference-aware brief job, got {matches_created}')
	...
	print(f'verify_daily_brief_pref_job_processed_user_count={result.processed_user_count}')
	print(f'verify_daily_brief_pref_job_sent_delivery_count={result.sent_delivery_count}')
	print(f'verify_daily_brief_pref_job_skipped_user_count={result.skipped_user_count}')
	...
	print(f'verify_daily_brief_pref_job_eligible_delivery_count={len(eligible_deliveries)}')
	print(f'verify_daily_brief_pref_job_blocked_delivery_count={len(blocked_deliveries)}')
	print(f'verify_daily_brief_pref_job_eligible_match_sent_at={eligible_match.sent_at.isoformat()}')
	print(f'verify_daily_brief_pref_job_blocked_match_sent_at={blocked_match.sent_at}')
