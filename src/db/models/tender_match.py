...
class TenderMatch(TimestampMixin, Base):
	...
	matched_country_codes: Mapped[list[str]] = mapped_column(
		ARRAY(String(2)),
		nullable=False,
		default=list,
		server_default='{}',
	)
	matched_industry_codes: Mapped[list[str]] = mapped_column(
		ARRAY(String(64)),
		nullable=False,
		default=list,
		server_default='{}',
	...
	daily_brief_queued_at: Mapped[datetime | None] = mapped_column(
		DateTime(timezone=True),
		nullable=True,
	)
	...
	instant_alert_queued_at: Mapped[datetime | None] = mapped_column(
		DateTime(timezone=True),
		nullable=True,
	)
