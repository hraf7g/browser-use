...
class BahrainTenderBoardQualityAssessment:
    """
    Deterministic quality assessment for one normalized Bahrain Tender Board payload.
...
def assess_bahrain_tender_board_payload(
    payload: TenderIngestionInput,
) -> BahrainTenderBoardQualityAssessment:
    """
    Assess one normalized Bahrain Tender Board payload for downstream data quality risk.
    ...
    return BahrainTenderBoardQualityAssessment(
        payload=payload,
...
def assess_bahrain_tender_board_payloads(
    payloads: Sequence[TenderIngestionInput],
) -> tuple[BahrainTenderBoardQualityAssessment, ...]:
    """Assess a sequence of normalized Bahrain Tender Board payloads."""
    return tuple(assess_bahrain_tender_board_payload(payload) for payload in payloads)
