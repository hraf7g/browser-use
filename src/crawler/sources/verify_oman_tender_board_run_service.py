...
def run() -> None:
    """
    Perform a production-grade persisted verification of the Oman Tender Board run service.
    ...
    with session_factory() as session:
        ...
        result = run_oman_tender_board_source(session=session)
        session.commit()
    ...
    with session_factory() as session:
        ...
        if result.status != "success":
            raise ValueError(
                "expected successful Oman Tender Board source run, got "
